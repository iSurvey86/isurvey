# 2026-09-03 — Export KML/KMZ + TM-6 + .NET 10

## Ngữ cảnh

Máy văn phòng: Civil 3D 2026 (R25.1) chạy .NET 10 → retarget `net10.0-windows`. Cuối phiên đầy đủ bump **1.1.0**.
...
- Map + Export: radio **Múi 3° / Múi 6°**; TM-6 snap CM **99 / 105 / 111**; cùng TOWGS84.
- Alias: **IG** / **SG** / **XG** / **EG**.
- Catalog lệnh: `docs/Danh_sach_lenh_iSurvey.xlsx`.
- Deploy: `build-bundle.ps1` path net10; `System.Drawing.Common` optional.
